...
?>
    ...
    <main id="conteudo-principal" class="container mt-4">
        <h1 class="visually-hidden">UNews - Notícias da UNESC</h1>
        ...
        <section class="ultimas-noticias-section mt-5">
            <h2 class="section-title" data-i18n="tituloSecao">Últimas Notícias</h2>
            
            <div class="row g-4 justify-content-center">
                <?php if (empty($noticias)): ?>
                    <p class="text-center" data-i18n="semNoticias">Nenhuma notícia publicada ainda nesta seção.</p>
                <?php else: ?>
